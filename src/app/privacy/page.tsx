      ...
      <section className="py-16 px-8 lg:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h3 className="text-xl font-bold mt-6 mb-3">3.1. Автоматически собираемые данные</h3>
            <p>При посещении нашего сайта мы можем автоматически собирать:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">9. Использование cookies и аналитики</h2>
            <p>
              Наш сайт использует cookies и сервисы аналитики для улучшения работы и понимания 
              поведения пользователей:
            </p>
            
            <h3 className="text-xl font-bold mt-6 mb-3">9.1. Типы cookies</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Необходимые cookies:</strong> Обеспечивают базовую функциональность сайта</li>
              <li><strong>Аналитические cookies:</strong> Помогают понять, как пользователи взаимодействуют с сайтом</li>
              <li><strong>Функциональные cookies:</strong> Запоминают ваши предпочтения и настройки</li>
            </ul>

            <h3 className="text-xl font-bold mt-6 mb-3">9.2. Сервисы аналитики</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Vercel Analytics:</strong> Анонимная аналитика производительности (не использует cookies)</li>
              <li><strong>Google Analytics:</strong> Анализ посещаемости и поведения пользователей (только с вашего согласия)</li>
            </ul>

            <h3 className="text-xl font-bold mt-6 mb-3">9.3. Управление cookies</h3>
            <p>
              Вы можете управлять cookies через настройки вашего браузера или использовать наш 
              баннер согласия на cookies. Отключение cookies может повлиять на функциональность сайта.
            </p>
